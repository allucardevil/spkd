...
<?php foreach($dev_bill as $db)
	...
	<tr>
		<td>Asal Airport</td><td>:</td><td><?php echo $db->in_asal;?></td>
	</tr>
	<tr>
		<td>Tgl Masuk/Keluar</td><td>:</td><td><?php echo mdate('%d-%m-%Y',strtotime($db->in_tgl_manifest)).'/'.mdate('%d-%m-%Y',strtotime($db->tglbayar));?></td>
	</tr>
	<tr>
		<td>Koli/Berat Aktual</td><td>:</td><td><?php echo $db->in_koli.' Koli / '.$db->in_berat_datang.' Kg';?></td>
	</tr>
	<tr>
		<td>Koli/Berat Bayar</td><td>:</td><td><?php echo $db->in_koli.' Koli / '.$db->in_berat_bayar.' Kg';?></td>
	</tr>
	<tr>
		<td>Komoditi</td><td>:</td><td><?php echo $db->in_jenisbarang;?></td>
	</tr>	
	<tr>
	...
	<tr>
		<td><center>Kasir</center></td><td></td><td><center>Penerima</center></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="3"><center>BUKTI SERAH TERIMA BARANG</center></td>
	</tr>
	<tr>
		<td colspan="3"><center><hr/></center></td>
	</tr>
	...
	<tr>
		<td>Flight Number</td><td>:</td><td>_______________________</td>
	</tr>
	<tr>
		<td>Tgl. Keluar</td><td>:</td><td>_______________________</td>
	</tr>
	<tr>
		<td>Koli / Berat Aktual</td><td>:</td><td>___________ /__________</td>
	</tr>
	<tr>
		<td><center>Petugas</center></td><td></td><td><center>Penerima</center></td>
	</tr>
	<tr>
		<td height="35px"></td><td></td><td></td>
	</tr>
	<tr>
		<td><center>____________________</center></td><td></td><td><center>____________________</center></td>
	</tr>
	<tr>
