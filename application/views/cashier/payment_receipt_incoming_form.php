...
document.getElementById("total").value = tsg;
				...
				<table>
					...
					{
						echo form_open('cashier/payment/save_payment/dbi'); 
					} else
					{
					...
					<tr>
						<td>Tanggal BTB</td>
						<td><input name="date" class="span2" placeholder="ALL" type="text" value="<?php echo mdate('%d-%m-%Y', strtotime($row->in_tgl_manifest)); ?>" readonly></td>
					</tr><tr>
						<td>BTB No</td>
							<td><input name="btb_no" class="span2" placeholder="ALL" type="text" value="<?php echo $row->in_btb; ?>" readonly></td>
					</tr>
					<tr>
						<td>Pengirim/Agent</td>
						<td><input name="agent" class="span2" placeholder="ALL" type="text" value="<?php echo $row->in_agent; ?>" readonly></td>
					</tr>
					<tr>
						<td>NO SMU</td>
						<td><input name="awb_no" class="span2" placeholder="-" type="text" value="<?php echo $row->in_smu; ?>" readonly></td>
					</tr>
					<tr>
						<td>Airline / Tujuan</td>
						<td><input name="airline" size="5" placeholder="ALL" type="text" value="<?php echo $row->in_airline; ?>" readonly> / <input name="airline" size="5" placeholder="ALL" type="text" value="<?php echo $row->in_tujuan; ?>" readonly></td>
					</tr>
					<tr>
						<td>Tanggal Masuk</td>
						<td><input name="date_in" class="span2" placeholder="ALL" type="text" value="<?php echo mdate('%d-%m-%Y %h:%i', strtotime($row->in_tgl_manifest)); ?>" readonly></td>
					</tr>
					<tr>
