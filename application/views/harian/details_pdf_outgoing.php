...
<div id="content">
		...
		<thead>
            ...
            <tr>
                ...
                <td align="right"><div align="right"><?php echo number_format($whc, 0, ',', '.'); ?></div></td>
                <td align="right"><div align="right"><?php echo number_format($csc, 0, ',', '.'); ?></div></td>
                <td align="right"><div align="right"><?php echo number_format($adm, 0, ',', '.'); ?></div></td>
                <td align="right"><div align="right"><?php echo number_format($whc+$csc+$adm, 0, ',', '.'); ?></div></td>
                <td align="right"><div align="right"><?php echo number_format($ppn, 0, ',', '.'); ?></div></td>
                <td align="right"><div align="right"><?php echo number_format(($whc+$csc+$adm+$ppn), 0, ',', '.'); ?></div></td>
            </tr>
            <?php 
			}
			$num++;
