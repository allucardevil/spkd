...
{ ?>
	...
	<tr>
		<td width="88px">Pengirim/Agent</td><td width="100px"><div align="left"> : <?php echo $row->in_agent;?></div></td>
	</tr>
	<tr>
		<td width="88px">Airline/Tujuan</td><td width="100px"><div align="left"> : <?php echo $row->in_airline."/".$row->in_tujuan;?></div></td>
	</tr>
	<tr>
		<td width="88px">No. SMU</td><td width="100px"><div align="left"> : <?php echo $row->in_smu;?></div></td>
	</tr>
	<tr>
		<td width="88px">Jenis Barang</td><td width="100px"><div align="left"> : <?php echo $row->in_jenisbarang;?></div></td>
	</tr>
<?php } ?>
</table>	
